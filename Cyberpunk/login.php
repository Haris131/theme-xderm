...
<html>
	...
	<style>
		...
		.box_login {
			...
			margin: 5% auto;
			padding: 1px 20px;
			box-shadow: 0px 0px 5px 2px #b659c9;
		}
		...
		.geser {
			...
			color: #ffffff;
			padding: 8px 20px;
			background-image: linear-gradient(45deg, #f3e600 50%, transparent 50%);
